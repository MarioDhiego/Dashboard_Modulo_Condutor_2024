...
Fiscalização em nível Estadual."
        ...
        tabItem(tabName = "conceitos",
                tabBox(id = "t3", width = 12,
                       tabPanel("REQUISITO PRA TIRAR CNH",
                                icon = icon("calendar"),
                                fluidRow(
                                  column(width = 4,
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
strong("A CNH é a sigla de Carteira Nacional de Habilitação, documento obrigatório para conduzir um veículos automotores e elétricos no território nacional. Segundo o CTB - Lei nº9.503/1997, para poder ter a CNH são requisito obrigatórios (Artigo 140):")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("1) Ser Penalmente Imputável, ou seja, alguém que responda pelos seus atos perante a Lei;")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("2) Saber Ler e Escrever, ou seja, não depende de grau de escolaridade, basta ser alfabetizado;")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
strong("3) Ter 18 anos Completo;")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
strong("4) Possuir Documento de Identificação: podendo ser qualquer documento de identificação emitido por Órgão Público que tenha fé pública (RG/ Carteira de Trabalho, Passaporte, ect.);")
),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("5) Possuir Cadastro de Pessoa Física (CPF);"))
                       ...
                       tabPanel("TIPOS DE CNH",
                                icon = icon("calendar"),
                                fluidRow(
                                  column(width = 4,
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
                                                strong("Existem vários tipos de CNH em vigor no Brasil com destaque para os ultimos 4 modelos que estavam e/ou estão em vigor.")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
                                                strong("1) Modelo Emitido de 30 de março de 2006 até dezembro de 2016 (Resolução CONTRAN Nº192/2006.)")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
                                                strong("2) Modelo Emitido de janeiro de 2017 até junho de 2019 (Resolução CONTRAN Nº598/2016.)")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
                                                strong("3) Modelo Emitido a partir de julho de 2019(Resolução CONTRAN Nº775/2019.)")),
                                         tags$br(),
                                         tags$p(style = "text-align:justify;font-si20pt",
                                                strong("4) Modelo Emitido a partir de dezembro de 2021 (Resolução CONTRAN Nº886/2021.)"))
                                  )
                                )
                       ),
tabPanel("CATEGORIA DA CNH", icon = icon("person"),
         fluidRow(
           column(width=4,solidHeader = TRUE,
                  tags$br(),
                  tags$p(style="text-align:justify;font-si20pt",
strong("Toda pessoa que conduza um veículo automotor, ou de outro tipo, incluindo os ciclos, ou que guie por uma via, cabeças de gado isoladas, rebanho, bando ou manadas, ou animais de tiro, carga ou sela. Sendo habilitados segundo CTB(Artigo 143) nas seguintes categorias;")),
tags$br(),
tags$p(style="text-align:justify;font-si20pt",
...
tabPanel("REGRAS DE MANTER A CNH", 
                                icon = icon("car"),
                                fluidRow(
                                  column(width = 4,
                                         tags$br(),
...
strong("As regras para manter a Carteira Nacional de Habilitação (CNH).")),
                                         tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("1) Não Ultrapassar o Limite de Pontos (20/30/40) Pontos Lei Nº 14.071(2020)")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("2) Não Tomar Infração Auto Suspensivas (2 a 8 meses)")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("2.1) Andar de Motocicleta Sem Capacetes;")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
strong("2.2) Recusar a Fazer o Teste do Etilômetro ou qualquer outro exame Clínico")),
tags$br(),
tags$p(style = "text-align:justify;font-si20pt",
...
tabPanel("RENOVAÇÃO DA CNH", 
         icon = icon("car"),
         fluidRow(
           column(width = 4,
                  tags$br(),
                  tags$p(style = "text-align:justify;font-si20pt",
strong("Renovação da CNH consiste no processo de solicitação de uma nova carteira nacional de habilitação para os motoristas do estado de moradia do condutor;")),
                  tags$br(),
                  tags$p(style = "text-align:justify;font-si20pt",
strong("1) O procedimento de Renovação deve ser realizado obrigatoriamente, quando a CNH:
Estiver perto de VenceR")),
                  tags$br(),
                  tags$p(style = "text-align:justify;font-si20pt",
strong("2) Estiver Vencida a mais de 30 dias;")),
                  tags$br(),
                  tags$p(style = "text-align:justify;font-si20pt",
strong("3) Quando Precisa Incluir novas informações no Campo Observação tais como exemplo(Hoje no Prontuário)")),
                  tags$br(),
                  tags$p(style = "text-align:justify;font-si20pt",
strong("4) Quando Precisa Incluir os Cursos Especializados e Obrigatórias conforme a Resolução Nº 789/2020")),
                  tags$br()
           ),
         )
),
